...
<div id="register">
    ...
    <form method="post" action="/user/register">
        <fieldset id="account-info">
            ...
            <p id="name-container">
                <label>Candidate Name: <input name="XD9phXNbqXjQM6w2OrCwxOb41jVI" type="text" value="" placeholder="Full name" title="We try to use your name whenever possible; however, there are some times when we display your username instead." required></label>
                <span class="fielderror"></span>
            </p>
            <p>
                <label>Experience: <input name="XDtFtUNqDbY2XXvtiGtgok3LHgPg" type="text" value="" placeholder="Relavant Experience" required></label>
                <span class="fielderror"></span>
            </p>
        <p>
            <label>
        ...
        <fieldset id="optin">
        <label>Skill Sets
        <input name="XDttwRdqBbY2XXvtiGtgok3LHgPg" type="checkbox" value="allmailings" > Java <&nbsp;>
        <input name="XDttwRdqBbY2XXvtiGtgok3LHgPg" type="checkbox" value=".net" > .NET</label>
