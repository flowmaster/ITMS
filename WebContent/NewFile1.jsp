    ...
    <div class="wrapper">
        ...
        <nav id="nav-account">
              ...
              <div class="logged_out">
                  <a href="https://sourceforge.net/auth/?return_to=/">Log In</a>
                <span>or</span>
...
<div id="register">
    ...
    <form method="post" action="/user/register">
        <fieldset id="account-info">
            ...
            <p id="name-container">
                <label>Name: <input name="XD9phXNbqXjQM6w2OrCwxOb41jVI" type="text" value="" placeholder="Full name" title="We try to use your name whenever possible; however, there are some times when we display your username instead." required></label>
                <span class="fielderror"></span>
            </p>
            <p>
                <label>Email: <input name="XDtFtUNqDbY2XXvtiGtgok3LHgPg" type="email" value="" placeholder="Your e-mail address" required></label>
                <span class="fielderror"></span>
            </p>
            <p>
        ...
        <p>
            <label>
                Country:
                <select id="country" name="XDNdvRN2bGsIdfNUhAIJqfsGhvgc" required>
...
<footer id="site-copyright-footer">
    <div class="wrapper">
        <div id="copyright">
            ...
            <!--<div id="dhi-service">SourceForge is a <a href="http://www.dhigroupinc.com">DHI</a> service.</div>-->
        </div>
        <nav>
