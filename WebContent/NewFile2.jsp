...
<div id="register">
    ...
    <form method="post" action="/user/register">
        ...
        <fieldset id="optin">
            <label><input name="XDttwRdqBbY2XXvtiGtgok3LHgPg" type="checkbox" value="level"> Required next level interview.</label>
        ...
        <p>
               <label> 
                    Interviewer:
                    <select name="XAtFtQd:AEd59OV8DLsFwJINMDWE">
